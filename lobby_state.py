...
def enter():
    ...
    oList.append(button('resource/mao.png', 50, 50))
    oList.append(button('resource/dao.png', 50, 50))
    #oList.append(button('resource/pre_char_s.png',400,400))
    #oList.append(button('resource/pre_char_s.png',400,400))
    ...
    oList[0].setClipSize(50,50)

    oList[1].setPos(320, 360)
    oList[1].setSize(180, 180)
    oList[1].setClipSize(50,50)
